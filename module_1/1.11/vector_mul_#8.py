...
Есть два вектора: a с координатами (x1, y1) и вектор b
с координатами (x2, y2).
Тогда скалярное произведение векторов b * a это следующее число
x2 * x1 + y2 * y1.
'''
class Point:
...
class Vector:
    ...
    def __mul__(self, vector):
        return self.coordinates.y * vector.coordinates.y + self.coordinates.x * vector.coordinates.x
